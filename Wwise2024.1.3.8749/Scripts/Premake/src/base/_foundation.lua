...
--
	...
	premake.TVOS        = "tvos"	-- AUDIOKINETIC
	premake.VISIONOS    = "visionos" -- AUDIOKINETIC
...
--
	...
	-- AUDIOKINETIC add an auto-warn-once for identical messages, global function
	function warnf(message, ...)
		premake.warnOnce(string.format(message, ...), message, ...)
	end
	-- AUDIOKINETIC end
