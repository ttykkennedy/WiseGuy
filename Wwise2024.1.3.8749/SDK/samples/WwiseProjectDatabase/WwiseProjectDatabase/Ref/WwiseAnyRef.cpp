...
{
	if (GetType() != WwiseRefType::SoundBank) [[unlikely]]
	{
		return nullptr;
	}
...
WwiseDBString WwiseAnyRef::GetPath(const WwiseRefType* TypeOverride) const
{
	const auto Type = TypeOverride ? *TypeOverride : GetType();
	switch (Type)
	{
	...
	case WwiseRefType::PluginLib: return {};
	case WwiseRefType::SoundBanksInfo: return {};
	case WwiseRefType::SoundBank: return GetSoundBank()->Path;
	case WwiseRefType::Media: return {};
	case WwiseRefType::CustomPlugin: return {};
	case WwiseRefType::PluginShareSet: return  {};
	case WwiseRefType::AudioDevice: return {};
	case WwiseRefType::Event: return {};
	case WwiseRefType::SwitchContainer: return {};
	case WwiseRefType::DialogueEvent: return {};
	case WwiseRefType::DialogueArgument: return  {};
	case WwiseRefType::Bus: return {};
	case WwiseRefType::AuxBus: return  {};
	case WwiseRefType::GameParameter: return  {};
	case WwiseRefType::StateGroup: return  {};
	case WwiseRefType::State: return  {};
	case WwiseRefType::SwitchGroup: return  {};
	case WwiseRefType::Switch: return  {};
	case WwiseRefType::Trigger: return  {};
	case WwiseRefType::ExternalSource: return  {};
	case WwiseRefType::AcousticTexture: return  {};
	case WwiseRefType::None:
	default:
		return {};
	}
...
WwiseDBString WwiseAnyRef::GetLanguageName(const WwiseRefType* TypeOverride) const
{
	const auto Type = TypeOverride ? *TypeOverride : GetType();
	switch (Type)
	{
	...
	case WwiseRefType::PluginLib: return {};
	case WwiseRefType::SoundBanksInfo: return {};
	case WwiseRefType::SoundBank: return GetSoundBank()->Language;
	case WwiseRefType::Media: return {};
	case WwiseRefType::CustomPlugin: return {};
	case WwiseRefType::PluginShareSet: return  {};
	case WwiseRefType::AudioDevice: return {};
