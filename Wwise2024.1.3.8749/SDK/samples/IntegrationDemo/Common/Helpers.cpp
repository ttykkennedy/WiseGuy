...
float IntegrationDemoHelpers::PixelsToAKPos_X(float m_fWidth, float in_X)
{
	return ((in_X / m_fWidth) - 0.5f) * POSITION_RANGE;
}

float IntegrationDemoHelpers::PixelsToAKPos_Y(float m_fHeight, float in_Y)
{
	return -((in_Y / m_fHeight) - 0.5f) * POSITION_RANGE;
}

float IntegrationDemoHelpers::PixelsToAKLen_X(float m_fWidth, float in_X)
{
	return (in_X / m_fWidth) * POSITION_RANGE;
}

float IntegrationDemoHelpers::PixelsToAKLen_Y(float m_fHeight, float in_Y)
{
	return (in_Y / m_fHeight) * POSITION_RANGE;
}

int IntegrationDemoHelpers::AKPosToPixels_X(float m_fWidth, double in_X)
{
	return (int)(((in_X / POSITION_RANGE) + 0.5f) * m_fWidth);
}

int IntegrationDemoHelpers::AKPosToPixels_Y(float m_fHeight, double in_Y)
{
