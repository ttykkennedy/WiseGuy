...
// Enable GME demo if Tencent GME plugin is installed locally (and the platform supports it)
#if defined(AK_PLATFORM_SUPPORTS_GME) && __has_include(<AK/Plugin/TencentGMEFactory.h>)
#define INTDEMO_LINK_GME
#endif
...
#if defined(INTDEMO_LINK_GME)

// Link statically with TencentGMEPlugin
#pragma comment(lib, "TencentGMEPlugin")

#endif // INTDEMO_LINK_GME
