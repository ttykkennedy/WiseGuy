...
#if !defined(INTEGRATIONDEMO_SCREEN_CHAR_WIDTH)
...
/// Call this after InitDrawing to compute a descriptor for a virtual gamepad overlay placed at the bottom of the layout window
VirtualGamepadLayout* Drawing_CreateGamepadLayout();

/// Dispose of the object created by Drawing_CreateGamepadOverlay
void Drawing_DestroyGamepadLayout(VirtualGamepadLayout* pOverlay);

/// Call this to draw a virtual gamepad on top of what has already been drawn every frame
