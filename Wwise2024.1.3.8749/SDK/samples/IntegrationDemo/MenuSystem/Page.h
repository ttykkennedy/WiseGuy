...
public:
	...
	/// Returns whether an warning has been set or not.
	/// \return True if an warning has occured and false otherwise.
	bool WarningOccured();
	...
	virtual void SetErrorMessage( const char* in_szError );
	
	/// Sets the Page's error appended with Plugin Errors
	virtual void SetPluginErrorMessage( const char* in_szError );
...
protected:
	...
	/// Set to 'true' if the help is a warning.
	string m_szWarning;
