...
#if 0 //#ifdef AK_PLATFORM_SUPPORTS_GME
	// Note: Future patches of GME will provide support for the GME page in the Integration Demo. Currently, it's unavailable.
	newBtn = new ButtonControl(*this);
	newBtn->SetLabel("GME Plug-in Demo");
	newBtn->SetDelegate((PageMFP)&BaseMenuPage::OpenGMEDemoPage);
	m_Controls.push_back(newBtn);
#endif
...
void BaseMenuPage::OpenGMEDemoPage(void*, ControlEvent*)
{
