...
public:
	...
	void OnDeviceChanged(AkUniqueID in_sharesetId, AkUInt32 in_idDeviceID);
...
private:
	...
	void RegisterMeteringCallback(AkOutputDeviceID in_idDeviceID);
	void UnregisterMeteringCallback();
