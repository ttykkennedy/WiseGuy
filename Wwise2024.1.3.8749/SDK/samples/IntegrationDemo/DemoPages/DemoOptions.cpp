...
const char* s_labelMemArenaMaxMemory = "Primary MemArena Limit:";
const char* s_labelMemArenaSbaInitSize = "Primary MemArena SBA Initial Size:";
const char* s_labelMemArenaTlsfInitSize = "Primary MemArena TLSF Initial Size:";
const char* s_labelMemArenaTlsfSpanSize = "Primary MemArena TLSF Span Size:";
...
void DemoOptions::InitMemorySettings()
{
	...
	newToggle = new ToggleControl(*this);
	newToggle->SetLabel(s_labelMemArenaMaxMemory);
	newToggle->AddOption("Disabled", (void*)0);
	newToggle->AddOption("16 MB", (void*)(16 * 1024 * 1024));
	newToggle->AddOption("32 MB", (void*)(32 * 1024 * 1024));
	newToggle->AddOption("64 MB", (void*)(64 * 1024 * 1024));
	uConfigVal = (AkUInt32)memSettings.memoryArenaSettings[AkMemoryMgrArena_Primary].uMemReservedLimit;
	switch (uConfigVal)
	{
	case 0: idx = 0; break;
	case (16 * 1024 * 1024): idx = 1; break;
	case (32 * 1024 * 1024): idx = 2; break;
	case (64 * 1024 * 1024): idx = 3; break;
	default:
		snprintf(buf, 20, "%i MB", uConfigVal);
		newToggle->AddOption(buf, (void*)(AkUIntPtr)uConfigVal);
		idx = 4;
		break;
	}
	newToggle->SetSelectedIndex(idx);
	...
	newToggle = new ToggleControl(*this);
	newToggle->SetLabel(s_labelMemArenaSbaInitSize);
	newToggle->AddOption("0 MB", (void*)0);
	newToggle->AddOption("2 MB", (void*)(2 * 1024 * 1024));
	newToggle->AddOption("8 MB", (void*)(8 * 1024 * 1024));
	uConfigVal = memSettings.memoryArenaSettings[AkMemoryMgrArena_Primary].uSbaInitSize;
	switch (uConfigVal)
	{
	case 0: idx = 0; break;
	case (2 * 1024 * 1024): idx = 1; break;
	case (8 * 1024 * 1024): idx = 2; break;
	default:
		snprintf(buf, 20, "%i MB", uConfigVal / (1024 * 1024));
		newToggle->AddOption(buf, (void*)((AkUIntPtr)uConfigVal));
		idx = 3;
		break;
	}
	...
	newToggle = new ToggleControl(*this);
	newToggle->SetLabel(s_labelMemArenaTlsfInitSize);
	newToggle->AddOption("0 MB", (void*)0);
	newToggle->AddOption("2 MB", (void*)(2 * 1024 * 1024));
	newToggle->AddOption("8 MB", (void*)(8 * 1024 * 1024));
	newToggle->AddOption("32 MB", (void*)(32 * 1024 * 1024));
	uConfigVal = memSettings.memoryArenaSettings[AkMemoryMgrArena_Primary].uTlsfInitSize;
	switch (uConfigVal)
	{
	case 0: idx = 0; break;
	case (2 * 1024 * 1024): idx = 1; break;
	case (8 * 1024 * 1024): idx = 2; break;
	case (32 * 1024 * 1024): idx = 3; break;
	default:
		snprintf(buf, 20, "%i MB", uConfigVal / (1024 * 1024));
		newToggle->AddOption(buf, (void*)((AkUIntPtr)uConfigVal));
		idx = 4;
	...
	newToggle = new ToggleControl(*this);
	newToggle->SetLabel(s_labelMemArenaTlsfSpanSize);
	newToggle->AddOption("64 KB", (void*)(64 * 1024));
	newToggle->AddOption("512 KB", (void*)(512 * 1024));
	newToggle->AddOption("2048 KB", (void*)(2 * 1024 * 1024));
	uConfigVal = memSettings.memoryArenaSettings[AkMemoryMgrArena_Primary].uTlsfSpanSize;
	switch (uConfigVal)
	{
	case (64 * 1024): idx = 0; break;
	case (512 * 1024): idx = 1; break;
	case (2 * 1024 * 1024): idx = 2; break;
	default:
		snprintf(buf, 20, "%i KB", uConfigVal / (1024));
		newToggle->AddOption(buf, (void*)((AkUIntPtr)uConfigVal));
		idx = 3;
		break;
	}
...
void DemoOptions::InitSettings_Changed(void* in_pSender, ControlEvent* in_pControlEvent)
{
	...
	memSettings.memoryArenaSettings[AkMemoryMgrArena_Primary].uMemReservedLimit = (AkUInt32)(AkUIntPtr)((ToggleControl*)FindControl(s_labelMemArenaMaxMemory))->SelectedValue();
	memSettings.memoryArenaSettings[AkMemoryMgrArena_Primary].uSbaInitSize = (AkUInt32)(AkUIntPtr)((ToggleControl*)FindControl(s_labelMemArenaSbaInitSize))->SelectedValue();
	memSettings.memoryArenaSettings[AkMemoryMgrArena_Primary].uTlsfInitSize = (AkUInt32)(AkUIntPtr)((ToggleControl*)FindControl(s_labelMemArenaTlsfInitSize))->SelectedValue();
	memSettings.memoryArenaSettings[AkMemoryMgrArena_Primary].uTlsfSpanSize = (AkUInt32)(AkUIntPtr)((ToggleControl*)FindControl(s_labelMemArenaTlsfSpanSize))->SelectedValue();
